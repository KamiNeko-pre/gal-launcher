...
<tr>
  <td>
    <h4>📚 批量收录与分类</h4>
    <p>选择一个总目录即可收录第一层游戏文件夹；可建立自己的分类、按题材筛选，并按标题或游玩时长排序。资料匹配有歧义时会留给你确认。</p>
  </td>
  <td>
    <h4>🕹️ 沉浸浏览与手柄</h4>
    <p>以全屏模式浏览书架，用手柄切换作品、查看资料、进入书架和切换主题。</p>
  </td>
</tr>
<tr>
  <td>
    <h4>🌏 转区启动</h4>
    <p>可按游戏使用 Locale Emulator 启动日语环境；支持绑定已有程序，也可按界面提示从官方来源下载部署。</p>
  </td>
  <td>
    <h4>✨ 游戏超分</h4>
    <p>可按游戏调用 Magpie，并提供轻量、均衡、高清和 4K 方案。不同游戏、显示器和显卡的实际效果会有所差异。</p>
  </td>
</tr>
</table>
...
推荐下载 ZIP 目录版，完整解压后运行：

```text
Gal Launcher.exe
```

ZIP 内的启动文件位于根目录，运行时请保留同目录下的资源文件。也可下载单文件 EXE 直接运行，无需手动解压；首次运行会释放运行文件，因此启动可能比 ZIP 目录版慢一些。
